    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valor', models.DecimalField(decimal_places=5, max_digits=25, verbose_name='Valor del Aporte')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valor', models.DecimalField(decimal_places=5, max_digits=25, verbose_name='Valor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('valor', models.DecimalField(decimal_places=5, max_digits=25, verbose_name='Valor a Pagar')),
                ('estado', models.CharField(choices=[('1', 'Activo'), ('0', 'Inactivo')], default='1', max_length=1, verbose_name='Estado')),
            ],
        ),
        migrations.CreateModel(
