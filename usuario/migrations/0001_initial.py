    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero_documento', models.CharField(max_length=10, validators=[django.core.validators.RegexValidator(re.compile('^-?\\d+\\Z'), code='invalid', message='Enter a valid integer.')], verbose_name='Número de Documento')),
                ...
                ('rol', models.CharField(choices=[('ADMI', 'Administardor'), ('VEN', 'Vendedor'), ('PROV', 'Proveedor'), ('CLIE', 'Cliente')], help_text='Roles:Administrador,Vendedor,Proveedor,Cliente', max_length=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ips', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='usuario.ips', verbose_name='Prestador de salud')),
                ('nomina', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='usuario.nomina', verbose_name='Npmmina')),
