...
class Compra(models.Model):
    ...
    persona_admin=models.ForeignKey(Persona,verbose_name="Administrador", on_delete=models.CASCADE,related_name="compras_administradas",limit_choices_to=Q(rol=Persona.Rol.ADMINISTRADOR))
